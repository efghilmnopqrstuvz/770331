...
<img src="https://github.com/efghilmnopqrstuvz/770331/blob/main/img_readme/final_clusters.png" width="400" height="400" />

### CLUSTER 0 -  _‘Newcomers’_ (red)
...
### CLUSTER 1 - _“To revive customers”_ (blue)
...
### CLUSTER 2 - _“To Be Loyal Customer”_ (purple)
...
### CLUSTER 3 - _‘Potential Profitable customers’_ (verde acqua)
This cluster is composed of 418 customers who have bought just once, on average more than two months ago. What makes this cluster valuable is that on average each customer has spent 1001 almost 9 times larger than the amount spent by the _“Newcomers”_, _“To-revive customers”_ and _“The Loyal to be Customers”_. The large monetary value amount is consistent to the fact that each customer ordered an average number of items fluctuating between 2 and 3. Moreover, these customers not only bought more products, but they purchased higher priced items. This can be confirmed by looking at the pie plot which displays a share of 12,6% for watches_gift whose price is 200. Moreover, among the _“other categories”_ section, we find in smaller percentage other high priced items such us musical instruments, computers, construction tools and small appliances, increasing the overall average price. 
Overall, the customers of this cluster can be considered as _“Potential Profitable Customers”_. The fact that the average number of items purchased fluctuates between 2 and 3, reveals that the customers were not just randomly on the website, but they intentionally chose to commit to the brand’s products. Therefore, retaining these customers is crucial due to their significant contribution to the company's revenue. 

### CLUSTER 4 - _“Best Friend customers”_ (magenta)
Cluster 4 is composed of a small subset of only 8 customers, who stand out as the most loyal customers of the shops. These individuals have demonstrated their commitment by making three purchases, thereby earning the distinction of being the _“Best Friend customers”_. On average, they have spent approximately 139 euros per order, slightly surpassing the monetary value observed in the first three clusters ( _“Newcomers”_, _“To-revive customers”_ and _“The Loyal to be Customers”_), although the difference is not significantly notable. Therefore, even though they have made frequent purchases, they are not valuable customers in terms of the total monetary value. However, these customers are important to the company, as they consistently contribute to its revenue stream through regular purchases.
Targeting efforts should be directed towards the _“Newcomers”_ (cluster 0) and _“The Loyal to be Customers”_ (cluster 2) , with the ultimate objective of converting them into “Best Friend Customers”. By incentivizing and encouraging these customers to increase their frequency of purchases and emulate the loyalty displayed by best friend customers, the company can maximize customer retention and strengthen its overall financial performance.

### CLUSTER 5 -  _“Stranded Customers”_ (green)
This cluster, composed of just 6 customers, comprises those users that have made one purchase more than one year ago ( Recency centroid = 377). They have spent on average 182 euros per order, an amount higher than the previous clusters with the only exception of cluster 3 _“the Potential Profitable Customers”_. The higher amount of money spent can be explained by the fact that on average each customer has purchased almost 3 items. They represent the lost customers of the company that could have represented a potential source of revenue, however, they have not been retained successfully.  

### CLUSTER 6 -  _“Elite Customers”_
...
### CLUSTER 7 - _“To be Profitable Loyal Customer”_ (orange)
Clusters 7 comprises 9 customers that have purchased twice from the company. The insights of this cluster are very consistent with the ones of cluster 2: _“To be Loyal customer”_, with just an important difference for the monetary value, which is about 5 times higher than the one of cluster 2. For this reason we can define this segment as _“To be Profitable Loyal Customer”_. The company should put effort in retaining them and strengthen the customer relationship in order not to lose them. Since they are a cluster anomaly and they share similar characteristics with cluster 2, it could be very effective for the company to apply the same tailored marketing campaign aiming to increase and stimulate the loyalty of these customer segments.

### CLUSTER 8 -  _“Rare Stellar Customers”_ (pink)
...
According to the insights emerged from the cluster analysis, we can make four main divisions for the targeted advertising objective: 
- “Establish a positive relationship” ads. A specific targeted marketing strategy can be implemented for the "Newcomers" customer segment, with the objective of cultivating positive relationships and guiding them throughout their customer journey.
- “Reviving the relationship” ads. A second marketing strategy can be applied to both “To revive customers” and “Stranded Customers” ,since they are the customers that have not purchased from the shop for a long time. The targeted ads must be aimed at reviving their interest and re-establishing a relationship. 
- “Nurturing profitable relationship” ads. “Potential Profitable Customers”, “Elite customers” and “Rare Stellar Customers” can be targeted with the same advertising strategy technique as they all have purchased once and display a considerable high amount of monetary value with respect to the rest of the other clusters. 
- “Achieving long-term loyalty” ads. “To be Loyal Customers” and “To be Profitable Loyal Customers” can be grouped together for the same marketing strategy. In this case, having purchased twice,  the business objective aims to nurture and strengthen the relationships in order to transform them into long-term loyal customers. Moreover, also “Best Friend customers” can be included in this marketing strategy in order to keep their loyalty alive. 
